/**
 * Beautiful, branded HTML email templates for DevPulse alerts.
 */
          ...
          <tr>
            <td align="center" style="padding-top:32px;">
              <p style="margin:0;font-size:12px;color:#64748b;">
                ...
                &bull; <a href="${FRONTEND_URL}" style="color:#8b5cf6;text-decoration:none;">Dashboard</a>
              </p>
          ...
          <table cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" style="
                ...
                padding:14px 32px;
              ">
                <a href="${FRONTEND_URL}/dashboard" style="color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;display:block;">
                  View Dashboard
                </a>
              </td>
            </tr>
...
module.exports = { generateDownEmail, generateUpEmail };
