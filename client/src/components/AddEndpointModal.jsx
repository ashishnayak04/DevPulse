...
import { X, Loader, Plus, Globe, Edit3, Clock } from 'lucide-react';
import { api } from '../api';
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              <h2 style={{ fontSize: '20px', fontWeight: '700' }}>Add Endpoint</h2>
              <p style={{ fontSize: '13px', color: 'var(--text-muted)' }}>Monitor a new API endpoint</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          >
            {loading ? <><Loader size={18} className="spin" /> Adding...</> : 'Add Endpoint'}
          </button>
        </form>
      </div>
    </>
